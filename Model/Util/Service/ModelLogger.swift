...
class ModelLogger {
    ...
    class func eventIn(_ file: String = #file, _ function: String = #function, _ line: Int = #line, chain: String = "") {
        ...
        if chain.isEmpty {
            Logger.verbose("\(fname).\(function) >>>", file, function, line: line, context: "M")
        } else {
            Logger.verbose("\(fname).\(function).\(chain) >>>", file, function, line: line, context: "M")
        }
    }
