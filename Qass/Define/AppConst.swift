...
final class AppConst {
    ...
    static let KEY_REALM_TOKEN = EnvDataModel.s.getEnv(key: "KEY_REALM_TOKEN") ?? "com.eifandevs.qass.realm-token"
    static let KEY_ENCRYPT_SERVICE_TOKEN = EnvDataModel.s.getEnv(key: "KEY_ENCRYPT_SERVICE_TOKEN") ?? "com.eifandevs.qass.encrypt-service-token"
    static let KEY_ENCRYPT_IV_TOKEN = EnvDataModel.s.getEnv(key: "KEY_ENCRYPT_IV_TOKEN") ?? "com.eifandevs.qass.encrypt-iv-token"
