...
public extension UIColor {
    ...
    /// サークル画像を作成
    public func circleImage(size: CGSize) -> UIImage {
    ...
    public static var ultraViolet: UIColor {
        return UIColor(hex: 0x5F4B8B, alpha: 1)
    }

    public static var lightUltraViolet: UIColor {
    ...
    public static var pasteLightGray: UIColor {
